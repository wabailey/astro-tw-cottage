	...
	theme: {
		...
		extend: {
			...
			fontSize: {
				...
				"hero-sm": ["32px", { lineHeight: "48px", letterSpacing: "0px", fontWeight: "400" }],
				...
				"body-sm-serif": ["14px", { lineHeight: "19px", letterSpacing: "1px", fontWeight: "400" }],
				...
				"body-sm": ["14px", { lineHeight: "18px", letterSpacing: "0.5px", fontWeight: "400" }],
